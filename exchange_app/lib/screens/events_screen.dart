        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: _padding),
              // Выбор даты для таблицы прибыли с помощью кнопок
              Card(
                elevation: 4,
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(_borderRadius),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                          ...
                          Row(
                            children: [
                              ElevatedButton(
                                ...
                                child: const Icon(Icons.arrow_left, color: _backgroundColor),
                              ),
                              ...
                              ElevatedButton(
                                ...
                                child: const Icon(Icons.arrow_right, color: _backgroundColor),
                              ),
                            ],
                          ),
                        ],
                      ...
                      Text(
                        DateFormat('dd.MM.yyyy').format(_selectedProfitDate),
